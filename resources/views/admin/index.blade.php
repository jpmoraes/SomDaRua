      ...
      <div class="col">
        <div class="card position-relative me-1">
          <button class="btn btn-primary custom-btn me-3" data-bs-toggle="modal" data-bs-target="#eventModal">
            <h1><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
          ...
          <div class="position-absolute bottom-0 end-0 m-1">
            ...
            <button class="btn btn-secondary btn-sm me-1" onclick="window.location.href='share.html'">
              <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-qr-code" viewBox="0 0 16 16">
                <path d="M2 2h2v2H2z"/>
