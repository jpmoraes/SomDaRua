<div class="card" style="width: 18rem;" id="icardEvento">
    ...
    <div class="position-absolute bottom-0 end-0 m-1">
        <button class="btn btn-secondary btn-sm me-1" data-bs-toggle="modal"
            data-bs-target="#iupdateModal{{$idEvento}}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateForm" method="post" action="{{route('evento.update', $idEvento)}}">
                            @csrf
                            @method('PUT')
                            <input type="text" name="estabelecimento_id" id="estabelecimento_id" style="display: none;"
                                value="1">
                                ...
                                <div id="socialMediaContainer">
                                    <div class="input-group" id="socialMedia1"
                                        ...
                                        <input type="text" aria-label="First name" class="form-control"
                                            style="flex: 1; margin-right:5px;" name="atracao">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="eventDescription" style="resize: vertical" name="descricao"
                                    required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="radio-group">
                                Terá Couvert?
                                <label><input class="caixa" type="radio" name="couvert" value="SIM"
                                        onclick="showInput()"> SIM </label>
                                <label><input class="caixa" type="radio" name="couvert" value="NÃO"
                                        onclick="hideInput()"> NÃO </label>
                            </div>
